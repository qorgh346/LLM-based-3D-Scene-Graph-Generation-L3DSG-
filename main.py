...
from src.model.model import L3DSGNet
...
def load_config():
    ...
    parser.add_argument('--config', type=str, default='config/L3DSGNet.json', help='configuration file name. Relative path under given path (default: config.yml)')
    ...
    parser.add_argument('--exp', default='Final Train',type=str)
